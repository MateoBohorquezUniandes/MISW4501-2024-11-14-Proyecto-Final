...
from usuarios.commands.utils import set_password
from usuarios.errors.errors import (CaractersEspeciales, EspacioenNombreUsuario,
                             FormatoInvalidoID, InformacionIncompletaNoValida,
                             UsuarioyaExiste)
# Pendiente configurar los errores
from usuarios.models.model import RoleUsuario, Usuario, db
...
class CrearUsuario(BaseCommannd):
    ...
    def execute(self):
        ...
        if not all(
            [self.nombre_usuario, self.apellido_usuario, self.numero_identificacion]
        ):
        ...
        usuario = Usuario(
            ...
            antiguedad_residencia=self.antiguedad_residencia,
            deportes_practicar=self.deportes_practicar,
            role_usuario=self.role_usuario,
